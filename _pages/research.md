...
In this line of work we have worked on efficient on-device DNN training. We proposed the TMModel, a ful performance model that captures the impacts of memory, and especially the texture cache, on performance of embedded GPUs.  ([ICS'2025](/files/2025_ICS_TMModel.pdf)). This modeling guides compiler-level optimizations of DNN inerence and training using operator fusion, data layout synthesis and selection, and sub-batch size selection 
