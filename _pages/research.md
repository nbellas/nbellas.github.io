...
Building on the previous paper’s idea of exploiting conservative hardware margins, this work extends the approach from CPUs to DRAM in cloud servers. With RM-DRAM, the authors show that relaxing memory operating margins can reduce energy use by up to 34.84% and operating cost by 29.53%, while managing reliability and SLA risks through cost-aware scheduling. ([CCGrid'2020](/files/CCGrid_2020.pdf))
